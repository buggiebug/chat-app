...
const Sidebar = ({ userAwth }) => {
  ...
  const { loadingState, getMyAllChats, myAllChatsState, deleteChats, userAddedToGroupState, removeFromAddingToGroup } = ChatHook();
        ...
        <div className="">
          ...
          {!viewProfileState &&
            <>
              ...
              {loadingState.loading && loadingState.loadingPath==="oneToOneChat" && <><SkletonModel /></>}
              <div className={``}>
