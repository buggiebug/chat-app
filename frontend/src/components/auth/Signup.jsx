  ...
  return <>
    ...
    <div className="w-full grid place-items-center">
        ...
        <div className="my-5 text-xl md:w-[60%] w-full">
          <h1 className="uppercase text-black">Create a new Account</h1>
        </div>
        ...
        <div className="md:w-[60%] w-full">
            ...
            <div className="">
              <form onSubmit={sendOtpSubmit}>
                  ...
                  <div className="flex justify-end mt-3">
                    <InputButton name={`Continue`} restClass={"bg-teal-800 w-1/2 hover:bg-teal-900 text-white"} loading={loadingState.loadingPath==="createAccount"?loadingState.loading:false}/>
                  </div>
              </form>
            </div>:""}
            ...
            <div className="">
                <form onSubmit={verifyOtpSubmit}>
                  <div className="flex flex-col justify-center">
                    <div className="my-5">
                      <p className="text-black">We send an OTP on your email</p>
                    </div>
                    <div className="flex justify-center">
                      {Array.from({length:otpLength},(e,index)=>(
                        <div key={index} className="mx-2">
                          ...
                          type="number"
                          className="w-12 h-12 border-2 border-transparent outline-none rounded-md focus:border-teal-700 text-center transition-all font-medium text-xl spin_button_none"/>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            {/*  */}
            <p className="mt-5">Already account <span onClick={()=>{loginSignupState("loginShow")}} className="underline text-blue-900 cursor-pointer">Login</span></p>
